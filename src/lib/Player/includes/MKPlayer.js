    ...
    loader: {
      value: function (stream) {
        ...
        for (i = 1; i < 32; ++i) {
          ...
          if (sample.length > 32768) this.version = SOUNDTRACKER_24;
        }

        stream.position = 950;
        this.length = stream.readUbyte();
        value = stream.readUbyte();
        this.restart = value < this.length ? value : 0;
        ...
        for (i = 1; i < 32; ++i) {
          ...
          if (sample.name.indexOf("2.0") > -1) this.version = NOISETRACKER_20;
          ...
          while (voice) {
            ...
            switch (voice.effect) {
              ...
              case 6: //vibrato + volume slide
                ...
                value =
                  ((voice.vibratoSpeed & 0x0f) * VIBRATO[value]) >>
                  this.vibratoDepth;
